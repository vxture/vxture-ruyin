...
| [ADR-024](ADR-024-contract-upgrade.md) | 既有项目跟上产品新版本：人点了才升、逐个项目；Runtime 先核新契约对快照「只增不删、不改窄」（不信版本号标签，信实际差异），放宽的安全相关声明不拦但逐条摆给人看；检查器在同构的 contract-schema 里 | 提议 | 2026-09-11 |
