...
| 授权本地资料 | ✅ | |
| **资料进入上下文** | ⚠️ | 承载面已可容纳非文本（M3）；**读懂 PDF / Word 仍缺**——属解析，等**某个业务产品自己的云端能力面**（TD-018；2026-09-02 更正：原写「归 Atlas」，那是错的——ADR-001 的标题就是「Ruyin 不直连 Atlas」） |
...
用户策略持久化 · **具体格式的解析**（等业务产品的云端能力面，TD-018；原写「归 Atlas」已更正）。
