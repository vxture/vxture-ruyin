...
const WRAPPER_CASES: WrapperCase[] = [
  ...
  { name: "updateChannel", call: (api) => api.updateChannel(), method: "GET", path: "/updates/channel" },
  {
    name: "setUpdateChannel",
    call: (api) => api.setUpdateChannel("beta"),
    method: "PUT",
  ...
  { name: "removePython", call: (api) => api.removePython(), method: "DELETE", path: "/python-runtime" },
